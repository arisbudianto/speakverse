    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-slate-500 dark:text-slate-400">
                This question will appear in the student Vocabulary Pretest
                (only questions with category "vocabulary" are shown to students).
            </p>

        </div>

        <form action="{{ route('admin.vocabulary-pretests.store') }}" method="POST"
